...
export const resetter: ApplyStyleObject = {
  ...
  'code, kbd, samp, pre':
    'font(family:{default-font-mono}) [fontFeatureSettings]-normal [fontVariationSettings]-normal text-1em',
  small: 'text-80%',
  ...
  '::placeholder': 'opacity1 [color]-[color-mix(in_oklab,_currentColor_50%,_transparent)]',
  textarea: 'resize-vertical',
  '::-webkit-search-decoration': '[webkitAppearance]-none',
  '::-webkit-date-and-time-value': 'h-min-1lh [textAlign]-inherit',
